    ...
    return (
        <div className="flex justify-center">
            <section className="w-full  bg-white p-10 ">
                <p className="text-center text-sm text-[#4CB7A5]">라이프 스타일 테스트</p>
                ...
                <p className="mt-3 text-center text-sm text-[#5F5F5F]">
                    <span className=" text-[#4CB7A5]">단 18문항!</span> 생활 습관 기반으로 매칭 결과까지 한 번에
                </p>

                <div className="mt-10 flex justify-center">
                    <div className="flex h-32 w-32 items-center justify-center ">
                        <Image src={checklistIcon} alt="체크리스트 아이콘" width={128} height={128} />
                    </div>
                </div>
