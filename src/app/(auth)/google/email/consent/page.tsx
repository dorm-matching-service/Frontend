  ...
  return (
    <div className="flex flex-col">
      ...
      >
        ...
        규정합니다. <br/>
        1. 서비스 목적 - 본 서비스는 학교 기숙사 내에서 룸메이트
        매칭을 돕기 위한 플랫폼입니다. - 사용자의 프로필 정보는 매칭을 위한
        목적에서만 활용됩니다. <br/>
        2. 서비스 이용 - 사용자는 서비스 이용을 위해 학교
        이메일 인증을 완료해야 합니다. - 사용자가 입력한 정보는 사실이어야 하며,
        허위 정보 입력으로 발생하는 책임은 사용자에게 있습니다. - 서비스는 매칭
        기능 제공을 보장하지 않으며, 매칭 성사 여부는 다양한 조건에 따라 달라질
        수 있습니다. <br/>
        3. 서비스 변경 및 종료 - 운영자는 서비스의 일부 또는 전체를
        변경·중단할 수 있으며, 중요한 변경이 있을 경우 사전 고지합니다. 
        4. 금지
        행위 - 타인의 정보를 도용하는 행위 - 비방, 욕설, 혐오 표현 등 커뮤니티
        질서를 해치는 행위 - 매칭을 목적으로 하지 않는 광고, 스팸, 영리 활동 
        5.면책 사항 - 운영자는 사용자의 귀책사유로 발생한 문제에 대해 책임을 지지
        않습니다. - 운영자는 서비스 이용 과정에서 발생할 수 있는 데이터 손실,
        매칭 실패 등에 대해 책임을 지지 않습니다. <br/>
        6. 기타 - 본 약관은 서비스 내
        공지사항을 통해 변경될 수 있습니다. - 변경된 약관은 공지된 시점부터
        효력이 발생합니다.
      </AgreementModal>
      ...
      >
        ...
        개인정보를 수집합니다.<br/>
        1. 수집 항목 [필수 정보] - 학교 이메일 - 이름
        또는 닉네임 - 성별 - 생활 패턴 정보 (기상·취침 시간, 소음 민감도 등) -
        선호하는 룸메이트 유형 정보 (생활 습관, 청결도 등) <br/>
        2. 수집 목적 - 기숙사
        룸메이트 매칭 기능 제공 - 본인 확인 및 학교 재학생 여부 확인 - 사용자 간
        매칭 알고리즘 분석 및 추천 <br/>
        3. 보유 및 이용 기간 - 서비스 이용 기간 동안
        보관되며, 회원 탈퇴 시 즉시 파기됩니다. - 단, 관계 법령에서 보관을
        요구하는 경우 해당 기간 동안 보관합니다. <br/>
        4. 동의 거부 권리 - 사용자는
        개인정보 수집·이용에 대한 동의를 거부할 수 있습니다. - 단, 필수 정보
        제공을 거부할 경우 룸메이트 매칭 기능 이용이 제한됩니다. <br/>
        5. 개인정보
